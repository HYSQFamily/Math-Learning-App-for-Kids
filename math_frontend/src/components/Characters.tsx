...
export function useCharacter(initialCharacterId: CharacterId = "huang-xiaoxing") {
  const [currentCharacterId, setCurrentCharacterId] = useState<CharacterId>(initialCharacterId);
